...
TRANSLATIONS = {'added_numbers': {'de': '  Hinzugefügte Nummern (am Ende angehängt): {}',
 ...
 'main_menu_options': {'de': 'Wählen Sie eine Option:\n'
                       ...
                       'zh': '选择一个选项：\n'
                             ...
                             '  0) 退出'},
 'main_menu_prompt': {'de': 'Wählen Sie 1, 2, 3, 4, 5, 6, 7, 8, 9 oder 0 [0]: ',
                      'en': 'Choose 1, 2, 3, 4, 5, 6, 7, 8, 9 or 0 [0]: ',
                      'es': 'Elige 1, 2, 3, 4, 5, 6, 7, 8, 9 o 0 [0]: ',
                      'it': 'Scegli 1, 2, 3, 4, 5, 6, 7, 8, 9 o 0 [0]: ',
                      'ja': '1, 2, 3, 4, 5, 6, 7, 8, 9 または 0 を選択 [0]: ',
                      'pl': 'Wybierz 1, 2, 3, 4, 5, 6, 7, 8, 9 lub 0 [0]: ',
                      'ru': 'Выберите 1, 2, 3, 4, 5, 6, 7, 8, 9 или 0 [0]: ',
                      'zh': '选择 1、2、3、4、5、6、7、8, 9 或 0 [0]：'},
